...
// ── Seed data ─────────────────────────────────────────────────────────
const SEED_CONTACTS = [
  { id:"1", company:"Randstad UK", contactName:"Priya Shah", title:"Chief People Officer", email:"p.shah@randstad.co.uk", phone:"07712 334 891", linkedin:"linkedin.com/in/priyashah", location:"London", companySize:"200+", website:"randstad.co.uk", stage:"Follow-up Due", source:"LinkedIn", assignedTo:"You", addedDate:"2026-04-18", lastContacted:"2026-04-26", followUpDate:"2026-04-26", currentSupplier:"Brook Street", contractEnd:"2026-09", frameworks:["CCS RM6277"], tags:["warm","key target"], estimatedValue:"", industry:"Recruitment", notes:"", activities:[
    {id:"a1",type:"Email",note:"Sent intro email outlining managed service offering. Referenced CCS framework renewal Sep 2026. No reply yet.",date:"2026-04-26",by:"You"},
    {id:"a2",type:"LinkedIn",note:"Connected and sent brief intro. She accepted connection within 24hrs — warm signal.",date:"2026-04-20",by:"You"},
    {id:"a3",type:"Note",note:"Randstad on CCS via Brook Street. Contract likely up Sep 2026. Good window Q2.",date:"2026-04-18",by:"You"},
  ]},
  { id:"2", company:"PageGroup", contactName:"Amy Lin", title:"Head of Operations", email:"a.lin@pagegroup.com", phone:"07834 221 005", linkedin:"", location:"Manchester", companySize:"51-200", website:"pagegroup.com", stage:"Contacted", source:"Scraped", assignedTo:"You", addedDate:"2026-04-20", lastContacted:"2026-04-24", followUpDate:"2026-04-30", currentSupplier:"", contractEnd:"", frameworks:["YPO 660"], tags:["warm"], estimatedValue:"", industry:"Recruitment", notes:"", activities:[
    {id:"a4",type:"Email",note:"Initial outreach email sent. Focused on YPO framework positioning.",date:"2026-04-24",by:"You"},
  ]},
  { id:"3", company:"Gi Group", contactName:"Laura Evans", title:"Managing Director", email:"l.evans@gigroup.co.uk", phone:"07911 443 229", linkedin:"linkedin.com/in/lauraevans", location:"Birmingham", companySize:"51-200", website:"gigroup.co.uk", stage:"Meeting Booked", source:"Framework", assignedTo:"You", addedDate:"2026-04-15", lastContacted:"2026-04-27", followUpDate:"2026-05-02", currentSupplier:"Adecco", contractEnd:"2026-12", frameworks:["CCS RM6277","ESPO 660"], tags:["key target"], estimatedValue:"", industry:"Staffing", notes:"", activities:[
    {id:"a5",type:"Email",note:"Confirmed video call for May 2 at 10am. Sent calendar invite.",date:"2026-04-27",by:"You"},
    {id:"a6",type:"Call",note:"Brief call — she's interested in switching supplier. Current contract with Adecco ends Dec.",date:"2026-04-22",by:"You"},
  ]},
  { id:"4", company:"Hays Recruitment", contactName:"Tom Brent", title:"Director", email:"t.brent@hays.com", phone:"", linkedin:"linkedin.com/in/tombrent", location:"London", companySize:"200+", website:"hays.com", stage:"New Lead", source:"Framework", assignedTo:"You", addedDate:"2026-04-27", lastContacted:"", followUpDate:"", currentSupplier:"Manpower", contractEnd:"", frameworks:["ESPO 660","CCS RM6277"], tags:[], estimatedValue:"", industry:"Recruitment", notes:"", activities:[]},
  { id:"5", company:"Pertemps", contactName:"Nicole Hart", title:"Director", email:"n.hart@pertemps.co.uk", phone:"07700 112 334", linkedin:"", location:"Coventry", companySize:"200+", website:"pertemps.co.uk", stage:"Won / Active", source:"Referral", assignedTo:"You", addedDate:"2026-03-10", lastContacted:"2026-04-24", followUpDate:"", currentSupplier:"", contractEnd:"", frameworks:["CCS RM6277"], tags:["active"], estimatedValue:"", industry:"Staffing", notes:"", activities:[
    {id:"a7",type:"Meeting",note:"Contract signed. Onboarding call completed. Live from May 1.",date:"2026-04-24",by:"You"},
  ]},
  { id:"6", company:"Morson Group", contactName:"Steve Holt", title:"CEO", email:"s.holt@morson.com", phone:"07811 556 234", linkedin:"", location:"Salford", companySize:"51-200", website:"morson.com", stage:"Proposal Sent", source:"LinkedIn", assignedTo:"You", addedDate:"2026-04-10", lastContacted:"2026-04-20", followUpDate:"2026-05-01", currentSupplier:"", contractEnd:"", frameworks:[], tags:["warm"], estimatedValue:"", industry:"Engineering Staffing", notes:"", activities:[
    {id:"a8",type:"Email",note:"Sent full proposal document. Outlined 3 service tiers. Awaiting decision.",date:"2026-04-20",by:"You"},
  ]},
  { id:"7", company:"Allegis Group", contactName:"Mark Finch", title:"VP Operations", email:"m.finch@allegis.com", phone:"07933 887 441", linkedin:"", location:"London", companySize:"200+", website:"allegis.com", stage:"Follow-up Due", source:"LinkedIn", assignedTo:"You", addedDate:"2026-04-19", lastContacted:"2026-04-25", followUpDate:"2026-04-27", currentSupplier:"Hays", contractEnd:"", frameworks:["CCS RM6277"], tags:[], estimatedValue:"", industry:"Recruitment", notes:"", activities:[
    {id:"a9",type:"LinkedIn",note:"Sent connection + message. Read but not replied.",date:"2026-04-25",by:"You"},
  ]},
  { id:"8", company:"Brook Street", contactName:"R. Patel", title:"Branch Manager", email:"r.patel@brookstreet.co.uk", phone:"", linkedin:"", location:"Leeds", companySize:"11-50", website:"brookstreet.co.uk", stage:"Lost / Dead", source:"Scraped", assignedTo:"You", addedDate:"2026-04-01", lastContacted:"2026-04-10", followUpDate:"", currentSupplier:"", contractEnd:"", frameworks:[], tags:[], lossReason:"No response", estimatedValue:"", industry:"Recruitment", notes:"", activities:[
    {id:"a10",type:"Email",note:"3 emails sent over 2 weeks. No response. Marking as dead for now.",date:"2026-04-10",by:"You"},
  ]},
];

const SEED_TEMPLATES = [
  { id:"t1", name:"Initial outreach", subject:"Exploring opportunities — [Company]", body:"Hi [Name],\n\nI came across [Company] and wanted to reach out directly. We work with a number of recruitment businesses helping them [key value prop].\n\nGiven your position on [Framework], I thought there might be a good fit worth exploring.\n\nWould you be open to a 20-minute call this week?\n\nBest,\n[Your name]" },
  { id:"t2", name:"Follow-up (no reply)", subject:"Re: Quick follow-up — [Company]", body:"Hi [Name],\n\nJust following up on my previous message — I know inboxes get busy.\n\nI genuinely think there's something worth a conversation here, particularly around your upcoming renewal.\n\nHappy to work around your schedule — even 15 minutes would be great.\n\nBest,\n[Your name]" },
  { id:"t3", name:"Post-meeting next steps", subject:"Great speaking — next steps", body:"Hi [Name],\n\nReally enjoyed our call today. As discussed, I'll put together a tailored proposal covering [topics discussed].\n\nI'll have that over to you by [date]. In the meantime, feel free to reach out with any questions.\n\nLooking forward to taking this forward.\n\nBest,\n[Your name]" },
  { id:"t4", name:"Proposal cover email", subject:"Proposal — [Company] x [Your company]", body:"Hi [Name],\n\nPlease find attached our proposal as discussed.\n\nThe document covers:\n• Our approach and methodology\n• Pricing across 3 service tiers\n• Case studies from similar organisations\n\nI'm happy to walk through it on a call — just let me know what works.\n\nBest,\n[Your name]" },
];
...
// ── Main App ──────────────────────────────────────────────────────────
export default function HawkeyeCRM(){
  ...
  const updateContact = (id, patch)=>{
    ...
    if(selectedContact===id) setSelectedContact(id); // keep open
  };

  const addContact = (data)=>{
    const c = {...data, id:uid(), addedDate:new Date().toISOString().slice(0,10), activities:[], tags:data.tags||[]};
    setContacts(cs=>[c,...cs]);
    toast("Contact added");
  };

  const logActivity = (contactId)=>{
    if(!newActivity.note.trim()) return;
    const act = {...newActivity, id:uid(), date:new Date().toISOString().slice(0,10), by:"You"};
    updateContact(contactId,{
      activities:[act,...(contacts.find(c=>c.id===contactId)?.activities||[])],
  ...
  const bulkStage = (stage)=>{
    selected.forEach(id=>moveStage(id,stage));
    setSelected([]);
    toast(`${selected.length} contacts updated`);
  };
  ...
  return (
    <div style={{display:"flex",height:"100vh",fontFamily:"'DM Sans', system-ui, sans-serif",background:"var(--color-background-tertiary)",fontSize:13,color:"var(--color-text-primary)"}}>
      ...
      <div style={{width:192,flexShrink:0,background:"var(--color-background-primary)",borderRight:"0.5px solid var(--color-border-tertiary)",display:"flex",flexDirection:"column",padding:"16px 0"}}>
        ...
        <div style={{padding:"0 16px 16px",borderBottom:"0.5px solid var(--color-border-tertiary)",marginBottom:8}}>
          <div style={{display:"flex",alignItems:"center",gap:7}}>
            <div style={{width:22,height:22,borderRadius:"50%",background:"#185FA5",display:"flex",alignItems:"center",justifyContent:"center"}}>
        ...
        <div style={{flex:1,padding:"4px 0"}}>
          {navItems.map(n=>(
            <div key={n.id} onClick={()=>setView(n.id)}
              style={{display:"flex",alignItems:"center",gap:8,padding:"7px 16px",fontSize:12,cursor:"pointer",color:view===n.id?"#185FA5":"var(--color-text-secondary)",background:view===n.id?"var(--color-background-secondary)":"transparent",borderRight:view===n.id?"2px solid #185FA5":"2px solid transparent",fontWeight:view===n.id?500:400}}>
        ...
        {/* User */}
        <div style={{borderTop:"0.5px solid var(--color-border-tertiary)",padding:"10px 16px",display:"flex",alignItems:"center",gap:8}}>
          <Avatar name="You" size={26}/>
          <div>
            <div style={{fontSize:11,fontWeight:500}}>You</div>
      ...
      <div style={{flex:1,display:"flex",flexDirection:"column",overflow:"hidden"}}>
        ...
        <div style={{background:"var(--color-background-primary)",borderBottom:"0.5px solid var(--color-border-tertiary)",padding:"0 20px",height:50,display:"flex",alignItems:"center",justifyContent:"space-between",flexShrink:0}}>
          <span style={{fontSize:14,fontWeight:500}}>
            {view==="contact"&&contact?`${contact.company} — ${contact.contactName}`:
             view==="dashboard"?"Dashboard":
             view==="followups"?"Follow-ups":
             view==="pipeline"?"Pipeline":
             view==="contacts"?"Contacts":"Templates"}
          </span>
        ...
        <div style={{flex:1,overflowY:"auto",padding:18}}>
          {view==="dashboard"&&<DashboardView contacts={contacts} openContact={openContact} setView={setView}/>}
          ...
          {view==="contacts"&&<ContactsView contacts={filteredContacts} allContacts={contacts} search={search} setSearch={setSearch} filterStage={filterStage} setFilterStage={setFilterStage} filterSource={filterSource} setFilterSource={setFilterSource} selected={selected} setSelected={setSelected} openContact={openContact}/>}
          ...
          {view==="templates"&&<TemplatesView templates={templates} setTemplates={setTemplates} setModal={setModal} toast={toast}/>}
        </div>
      </div>
      ...
      {modal?.type==="template"&&<TemplateModal template={modal.template} onClose={closeModal} onSave={(t)=>{setTemplates(ts=>modal.template?.id?ts.map(x=>x.id===t.id?t:x):[...ts,{...t,id:uid()}]);closeModal();toast("Template saved");}}/>}
...
// ── Dashboard ─────────────────────────────────────────────────────────
function DashboardView({contacts,openContact,setView}){
  ...
  const recentActs = contacts.flatMap(c=>(c.activities||[]).map(a=>({...a,company:c.company,contactId:c.id}))).sort((a,b)=>new Date(b.date)-new Date(a.date)).slice(0,6);
  ...
  return (
    <div>
      <div style={{display:"grid",gridTemplateColumns:"repeat(4,minmax(0,1fr))",gap:10,marginBottom:16}}>
        {[
          {label:"Total contacts",value:contacts.length,sub:`+${contacts.filter(c=>daysAgo(c.addedDate)==="Today"||daysAgo(c.addedDate)==="Yesterday").length} this week`,up:true},
          {label:"Active pipeline",value:contacts.filter(c=>!["Won / Active","Lost / Dead"].includes(c.stage)).length,sub:"In progress"},
          {label:"Won / active",value:contacts.filter(c=>c.stage==="Won / Active").length,sub:"Clients",up:true},
          {label:"Overdue follow-ups",value:overdue.length,sub:"Need attention",warn:overdue.length>0},
        ].map((m,i)=>(
          <div key={i} style={{background:"var(--color-background-secondary)",borderRadius:8,padding:"11px 14px"}}>
            ...
            <div style={{fontSize:11,color:m.up?"#0F6E56":"var(--color-text-secondary)",marginTop:1}}>{m.sub}</div>
          </div>
        ))}
      </div>
      <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:12,marginBottom:12}}>
        ...
        <div style={cardStyle}>
          ...
          {overdue.length===0?<div style={{fontSize:12,color:"var(--color-text-tertiary)",padding:"12px 0"}}>All clear — no overdue follow-ups</div>:
          overdue.slice(0,4).map(c=>(
            <div key={c.id} onClick={()=>openContact(c)} style={{display:"flex",alignItems:"center",gap:8,padding:"5px 0",borderBottom:"0.5px solid var(--color-border-tertiary)",cursor:"pointer"}}>
              ...
              <div style={{flex:1,overflow:"hidden"}}>
                <div style={{fontSize:11,fontWeight:500,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"}}>{c.company}</div>
                <div style={{fontSize:10,color:"var(--color-text-secondary)"}}>{c.contactName}</div>
              </div>
...
function FollowupsView({contacts,openContact,updateContact,toast}){
  ...
  const FUItem = ({c,urgent})=>(
    <div onClick={()=>openContact(c)} style={{...cardStyle,display:"flex",alignItems:"center",gap:10,padding:"10px 12px",cursor:"pointer",borderLeft:urgent?"3px solid #E24B4A":"0.5px solid var(--color-border-tertiary)",borderRadius:urgent?0:8,marginBottom:6}}>
      ...
      <div style={{flex:1}}>
        <div style={{fontSize:12,fontWeight:500}}>{c.company} — {c.contactName}</div>
        <div style={{fontSize:11,color:"var(--color-text-secondary)",marginTop:1}}>{c.activities?.[0]?.note?.slice(0,60)||"No recent activity"}…</div>
      </div>
      <div style={{display:"flex",flexDirection:"column",alignItems:"flex-end",gap:4}}>
        <div style={{fontSize:11,color:urgent?"#A32D2D":"var(--color-text-tertiary)",fontWeight:urgent?500:400}}>{daysAgo(c.followUpDate)}</div>
  ...
  return (
    <div>
      ...
      {noDate.length>0&&(
        <><div style={{fontSize:12,fontWeight:500,margin:"14px 0 8px",color:"var(--color-text-secondary)"}}>No follow-up date set ({noDate.length})</div>
...
function PipelineView({contacts,openContact,moveStage,setModal,stalContacts}){
  ...
  return (
    <div>
      {stalContacts.length>0&&(
        <div style={{background:"#FAEEDA",border:"0.5px solid #EF9F27",borderRadius:8,padding:"8px 12px",marginBottom:12,display:"flex",alignItems:"center",gap:8}}>
          <span style={{fontSize:11,color:"#633806"}}>⚠ {stalContacts.length} contact{stalContacts.length>1?"s":""} not touched in 14+ days: {stalContacts.map(c=>c.company).join(", ")}</span>
        </div>
      )}
            ...
            <div key={stage} style={{minWidth:168,flexShrink:0}}>
              ...
              {cols.map(c=>(
                <div key={c.id} onClick={()=>openContact(c)}
                  style={{background:"var(--color-background-primary)",border:stalIds.has(c.id)?"1px solid #EF9F27":"0.5px solid var(--color-border-tertiary)",borderRadius:8,padding:"9px",marginBottom:5,cursor:"pointer",opacity:stage==="Lost / Dead"?0.55:1}}>
                  ...
                  <div style={{display:"flex",alignItems:"center",justifyContent:"space-between"}}>
                    ...
                    <span style={{fontSize:10,color:isOverdue(c.followUpDate)?"#A32D2D":stalIds.has(c.id)?"#854F0B":"var(--color-text-tertiary)",fontWeight:isOverdue(c.followUpDate)?500:400}}>
                      {isOverdue(c.followUpDate)?"Overdue":stalIds.has(c.id)?"Stale":daysAgo(c.addedDate)||""}
                    </span>
                  </div>
              ...
              <button onClick={()=>setModal({type:"addContact",stage})}
                style={{width:"100%",border:"0.5px dashed var(--color-border-secondary)",borderRadius:8,padding:"6px",fontSize:11,color:"var(--color-text-tertiary)",background:"transparent",cursor:"pointer",marginTop:2}}>+ Add here</button>
            </div>
          );
        })}
      </div>
        ...
        <table style={{width:"100%",borderCollapse:"collapse",fontSize:12,tableLayout:"fixed"}}>
          <thead>
            <tr style={{borderBottom:"0.5px solid var(--color-border-tertiary)"}}>
              ...
              <th style={thStyle}>Company</th><th style={thStyle}>Contact</th><th style={thStyle}>Stage</th>
              <th style={thStyle}>Tags</th><th style={thStyle}>Supplier</th><th style={thStyle}>Follow-up</th><th style={thStyle}>Source</th>
            </tr>
          </thead>
          <tbody>
            {contacts.map(c=>(
              <tr key={c.id} onClick={()=>openContact(c)} style={{borderBottom:"0.5px solid var(--color-border-tertiary)",cursor:"pointer"}}
                ...
                <td style={{padding:"8px"}}>
                  <div style={{display:"flex",alignItems:"center",gap:6}}>
                    <Avatar name={c.contactName} size={22}/>
                    <span style={{overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"}}>{c.contactName}</span>
                  </div>
                </td>
                <td style={{padding:"8px"}}><StagePill stage={c.stage} small/></td>
                <td style={{padding:"8px"}}>
                  <div style={{display:"flex",flexWrap:"wrap",gap:3}}>
                    {(c.tags||[]).slice(0,2).map(t=><span key={t} style={{fontSize:9,padding:"1px 5px",borderRadius:8,background:"#E6F1FB",color:"#0C447C"}}>{t}</span>)}
                  </div>
                </td>
...
function ContactProfile({contact,updateContact,moveStage,newActivity,setNewActivity,logActivity,setView,setModal,templates}){
  ...
  const addTag=(t)=>{
    if(!t.trim()||contact.tags?.includes(t)) return;
    updateContact(contact.id,{tags:[...(contact.tags||[]),t.trim()]});
    setTagInput("");
  };
  const removeTag=(t)=>updateContact(contact.id,{tags:(contact.tags||[]).filter(x=>x!==t)});

  const applyTemplate=(tmpl)=>{
    setNewActivity(a=>({...a,type:"Email",note:tmpl.body.replace(/\[Name\]/g,contact.contactName.split(" ")[0]).replace(/\[Company\]/g,contact.company)}));
    ...
    <div>
      ...
      <div style={{display:"flex",alignItems:"center",gap:8,marginBottom:14}}>
        ...
        <div style={{marginLeft:"auto",display:"flex",gap:7}}>
          ...
          <select value={contact.stage} onChange={e=>moveStage(contact.id,e.target.value)} style={{...inputStyle,fontSize:11}}>
            {STAGES.map(s=><option key={s} value={s}>{s}</option>)}
          </select>
        </div>
      </div>
        ...
        <div style={{width:224,flexShrink:0,display:"flex",flexDirection:"column",gap:10}}>
          ...
          <div style={cardStyle}>
            <div style={{display:"flex",alignItems:"center",gap:10,marginBottom:12}}>
              ...
              <div>
                <div style={{fontSize:14,fontWeight:500}}>{contact.contactName}</div>
                <div style={{fontSize:11,color:"var(--color-text-secondary)",marginTop:1}}>{contact.title}</div>
                <div style={{fontSize:11,color:"#185FA5",marginTop:1}}>{contact.company}</div>
              </div>
            </div>
            {[
              {l:"Email",v:contact.email,link:true},
              {l:"Phone",v:contact.phone},
              {l:"LinkedIn",v:contact.linkedin?"View profile":null,link:true},
              {l:"Location",v:contact.location},
              {l:"Size",v:contact.companySize},
              {l:"Industry",v:contact.industry},
          ...
          <div style={cardStyle}>
            ...
            {[
              {l:"Stage",v:<StagePill stage={contact.stage} small/>},
              {l:"Source",v:contact.source},
              {l:"Assigned",v:contact.assignedTo},
              {l:"Added",v:contact.addedDate},
              {l:"Last contact",v:contact.lastContacted?daysAgo(contact.lastContacted):"Never"},
            ].map(({l,v})=>(
            ...
            <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",padding:"4px 0",gap:8}}>
              ...
              {editFollowUp
                ? <input type="date" defaultValue={contact.followUpDate||""} onBlur={e=>{updateContact(contact.id,{followUpDate:e.target.value});setEditFollowUp(false);}} autoFocus style={{fontSize:10,padding:"2px 5px",border:"0.5px solid var(--color-border-secondary)",borderRadius:4,background:"var(--color-background-primary)",color:"var(--color-text-primary)"}}/>
                : <span onClick={()=>setEditFollowUp(true)} style={{fontSize:11,color:isOverdue(contact.followUpDate)?"#A32D2D":"#185FA5",cursor:"pointer",fontWeight:isOverdue(contact.followUpDate)?500:400}}>{contact.followUpDate?`${daysAgo(contact.followUpDate)}`:"Set date"}</span>
              }
            </div>
          </div>
          ...
          <div style={cardStyle}>
            ...
            <div style={{display:"flex",flexWrap:"wrap",gap:4,marginBottom:8}}>
              {(contact.tags||[]).map(t=>(
                <span key={t} onClick={()=>removeTag(t)} style={{fontSize:10,padding:"2px 7px",borderRadius:10,background:"#E6F1FB",color:"#0C447C",cursor:"pointer"}}>{t} ×</span>
              ))}
            </div>
            ...
            <div style={{display:"flex",flexWrap:"wrap",gap:3}}>
              {TAGS_PRESET.filter(t=>!(contact.tags||[]).includes(t)).map(t=>(
                <span key={t} onClick={()=>addTag(t)} style={{fontSize:9,padding:"2px 6px",borderRadius:8,background:"var(--color-background-secondary)",color:"var(--color-text-secondary)",cursor:"pointer"}}>{t}</span>
              ))}
            </div>
          </div>

          {contact.lossReason&&(
            <div style={{...cardStyle,background:"#F1EFE8"}}>
              <div style={{fontSize:10,fontWeight:500,color:"#5F5E5A",marginBottom:4}}>LOSS REASON</div>
              <div style={{fontSize:12,color:"#444441"}}>{contact.lossReason}</div>
            </div>
          )}
        </div>
        ...
        <div style={{flex:1,minWidth:0}}>
          <div style={cardStyle}>
            ...
            <div style={{display:"flex",gap:6,marginBottom:14,flexWrap:"wrap"}}>
              <select value={newActivity.type} onChange={e=>setNewActivity(a=>({...a,type:e.target.value}))} style={{...inputStyle,fontSize:11}}>
                {ACTIVITY_TYPES.map(t=><option key={t}>{t}</option>)}
              </select>
              <div style={{flex:1,position:"relative",minWidth:180}}>
                <input value={newActivity.note} onChange={e=>setNewActivity(a=>({...a,note:e.target.value}))} onKeyDown={e=>e.key==="Enter"&&logActivity(contact.id)} placeholder="Log an interaction or note… (Enter to save)" style={{...inputStyle,width:"100%"}}/>
              </div>
            ...
            {showTemplates&&(
              <div style={{background:"var(--color-background-secondary)",borderRadius:8,padding:10,marginBottom:12}}>
                <div style={{fontSize:11,fontWeight:500,marginBottom:8}}>Choose a template</div>
                <div style={{display:"flex",flexDirection:"column",gap:5}}>
                  {templates.map(t=>(
                    <div key={t.id} onClick={()=>applyTemplate(t)} style={{fontSize:11,padding:"6px 10px",borderRadius:6,background:"var(--color-background-primary)",border:"0.5px solid var(--color-border-tertiary)",cursor:"pointer"}}>
                      <div style={{fontWeight:500}}>{t.name}</div>
                      <div style={{color:"var(--color-text-secondary)",marginTop:1}}>{t.subject}</div>
                    </div>
                  ))}
                </div>
              </div>
              ...
              {(contact.activities||[]).map((a,i)=>{
                ...
                return (
                  <div key={a.id} style={{display:"flex",gap:10,padding:"10px 0",borderBottom:i<contact.activities.length-1?"0.5px solid var(--color-border-tertiary)":"none"}}>
                    ...
                    <div style={{flex:1}}>
                      <div style={{fontSize:11,fontWeight:500,marginBottom:2}}>{a.type}</div>
                      <div style={{fontSize:12,color:"var(--color-text-secondary)",lineHeight:1.5}}>{a.note}</div>
                      <div style={{fontSize:10,color:"var(--color-text-tertiary)",marginTop:4}}>{a.date} · {a.by}</div>
                    </div>
                  </div>
                );
              })}
...
// ── Templates ─────────────────────────────────────────────────────────
function TemplatesView({templates,setTemplates,setModal,toast}){
  const del=(id)=>{ setTemplates(ts=>ts.filter(t=>t.id!==id)); toast("Template deleted"); };
  return (
    <div>
      <div style={{display:"flex",justifyContent:"flex-end",marginBottom:14}}>
        <button style={{...btnStyle,background:"#185FA5",color:"white",border:"none"}} onClick={()=>setModal({type:"template",template:null})}>+ New template</button>
      </div>
      <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(260px,1fr))",gap:12}}>
        {templates.map(t=>(
          <div key={t.id} style={cardStyle}>
            ...
            <div style={{fontSize:11,color:"var(--color-text-secondary)",lineHeight:1.6,whiteSpace:"pre-wrap",maxHeight:80,overflow:"hidden",maskImage:"linear-gradient(black 60%,transparent)"}}>{t.body}</div>
            <div style={{display:"flex",gap:7,marginTop:12}}>
              <button style={btnStyle} onClick={()=>setModal({type:"template",template:t})}>Edit</button>
              <button style={{...btnStyle,color:"#A32D2D",borderColor:"#F09595"}} onClick={()=>del(t.id)}>Delete</button>
            </div>
          </div>
        ))}
      </div>
    ...
    <Modal onClose={onClose}>
      ...
      <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:10,marginBottom:10}}>
        {[["Company","company"],["Contact name","contactName"],["Job title","title"],["Email","email"],["Phone","phone"],["LinkedIn URL","linkedin"],["Location","location"],["Website","website"],["Current supplier","currentSupplier"],["Contract end (e.g. 2026-09)","contractEnd"],["Industry","industry"]].map(([l,k])=>(
          <div key={k}>
            ...
            <input value={form[k]||""} onChange={e=>set(k,e.target.value)} style={{...inputStyle,width:"100%"}}/>
          </div>
        ))}
        <div>
          <div style={{fontSize:11,color:"var(--color-text-secondary)",marginBottom:3}}>Company size</div>
          <select value={form.companySize} onChange={e=>set("companySize",e.target.value)} style={{...inputStyle,width:"100%"}}>
            <option value="">Select…</option>{["1-10","11-50","51-200","200+"].map(s=><option key={s}>{s}</option>)}
          </select>
        </div>
        <div>
          <div style={{fontSize:11,color:"var(--color-text-secondary)",marginBottom:3}}>Stage</div>
          <select value={form.stage} onChange={e=>set("stage",e.target.value)} style={{...inputStyle,width:"100%"}}>
            {STAGES.map(s=><option key={s}>{s}</option>)}
          </select>
        </div>
        <div>
          <div style={{fontSize:11,color:"var(--color-text-secondary)",marginBottom:3}}>Source</div>
          <select value={form.source} onChange={e=>set("source",e.target.value)} style={{...inputStyle,width:"100%"}}>
            {SOURCES.map(s=><option key={s}>{s}</option>)}
          </select>
        </div>
        <div>
          <div style={{fontSize:11,color:"var(--color-text-secondary)",marginBottom:3}}>Follow-up date</div>
          <input type="date" value={form.followUpDate||""} onChange={e=>set("followUpDate",e.target.value)} style={{...inputStyle,width:"100%"}}/>
        </div>
      </div>
      <div style={{marginBottom:12}}>
        ...
        <div style={{display:"flex",flexWrap:"wrap",gap:5}}>
          {FRAMEWORKS.map(fw=>(
            <span key={fw} onClick={()=>toggleFW(fw)} style={{fontSize:10,padding:"3px 9px",borderRadius:10,cursor:"pointer",background:form.frameworks.includes(fw)?"#EEEDFE":"var(--color-background-secondary)",color:form.frameworks.includes(fw)?"#3C3489":"var(--color-text-secondary)",border:form.frameworks.includes(fw)?"0.5px solid #AFA9EC":"0.5px solid transparent"}}>{fw}</span>
          ))}
        </div>
      </div>
  ...
  return (
    <Modal onClose={onClose}>
      ...
      <div style={{display:"flex",flexWrap:"wrap",gap:7,marginBottom:16}}>
        {reasons.map(r=>(
          <span key={r} onClick={()=>setReason(r)} style={{fontSize:12,padding:"6px 12px",borderRadius:8,cursor:"pointer",background:reason===r?STAGE_STYLE[stage].bg:"var(--color-background-secondary)",color:reason===r?STAGE_STYLE[stage].color:"var(--color-text-secondary)",border:reason===r?"0.5px solid currentColor":"0.5px solid transparent"}}>{r}</span>
        ))}
      </div>
  ...
  return (
    <Modal onClose={onClose}>
      ...
      <div style={{marginBottom:10}}>
        <div style={{fontSize:11,color:"var(--color-text-secondary)",marginBottom:3}}>Template name</div>
        <input value={form.name} onChange={e=>setForm(f=>({...f,name:e.target.value}))} style={{...inputStyle,width:"100%"}}/>
      </div>
      <div style={{marginBottom:10}}>
        <div style={{fontSize:11,color:"var(--color-text-secondary)",marginBottom:3}}>Subject line</div>
        <input value={form.subject} onChange={e=>setForm(f=>({...f,subject:e.target.value}))} style={{...inputStyle,width:"100%"}}/>
      </div>
      <div style={{marginBottom:10}}>
        <div style={{fontSize:11,color:"var(--color-text-secondary)",marginBottom:3}}>Body — use [Name], [Company] as placeholders</div>
        <textarea value={form.body} onChange={e=>setForm(f=>({...f,body:e.target.value}))} rows={10} style={{...inputStyle,width:"100%",resize:"vertical",lineHeight:1.6}}/>
      </div>
      <div style={{display:"flex",justifyContent:"flex-end",gap:8}}>
        <button style={btnStyle} onClick={onClose}>Cancel</button>
